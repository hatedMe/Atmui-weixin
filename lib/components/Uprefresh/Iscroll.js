...
class IScroll {
    ...
    onTouchMove(e) {
        ...
        //console.log( this.touches.currentPosY , 'qianyici' );

        if( -this.touches.diffY >=100 ){
            
            // this.touches.currentPosY = this.touches.posY - this.touches.diffY / ;
            //let newY = Math.abs(this.touches.diffY) * 0.01 ;
            //this.touches.currentPosY = this.touches.currentPosY + newY;

            this.touches.diffY = this.touches.diffY / 3;

            console.log( this.touches.diffY , 'houyici' );
            //console.log( newY , '=======', this.touches.currentPosY *0.01 );
        }
    ...
    onTouchEnd(e) {
        ...
        this.wrapper.style.webkitTransitionTimingFunction = 'cubic-bezier(0.1, 0.57, 0.1, 1)';
